  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    ...
    http
        ...
        .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/auth/signup", "/api/auth/login", "/api/auth/reissue")
                .permitAll()
                .requestMatchers("/api/goal/**", "/api/nego", "/api/friend/**", "/api/dutchpay/**", "/api/allowance/list")
                .hasRole(Role.CHILD.toString())
                .requestMatchers("/api/mission", "/api/nego/manage", "/api/allowance/add", "/api/allowance/info","/api/allowance/children")
                .hasRole(Role.ADULT.toString())
//                .requestMatchers("/api/mission/list", "/api/mission/success-rate")
//                .hasAnyRole(Role.ADULT.toString(), Role.CHILD.toString())
                .anyRequest()
                .authenticated()
        )
