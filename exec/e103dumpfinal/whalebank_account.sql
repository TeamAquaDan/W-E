...
CREATE TABLE `account` (
  ...
  `day_limit_amt` int NOT NULL DEFAULT '5000000',
  `issue_date` datetime(6) DEFAULT NULL,
  `once_limit_amt` int NOT NULL DEFAULT '1000000',
  `parking_balance_amt` int NOT NULL DEFAULT '0',
  `withdrawable_amt` int NOT NULL DEFAULT '5000000',
