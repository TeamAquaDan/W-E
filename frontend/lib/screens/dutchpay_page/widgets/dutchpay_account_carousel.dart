...
class DutchPayAccountCarousel extends StatefulWidget {
  ...
  const DutchPayAccountCarousel(
      {super.key, required this.transactions, required this.roomId});
...
void showAccountCarouselDialogDutchPay(
    BuildContext context, List<Map<String, dynamic>> transactions, int roomId) {
  showDialog(
    context: context,
    builder: (BuildContext context) {
      return DutchPayAccountCarousel(
          transactions: transactions, roomId: roomId);
    },
  );
}
