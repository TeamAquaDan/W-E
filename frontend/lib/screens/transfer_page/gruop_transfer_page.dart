...
class GroupTransferPage extends StatefulWidget {
  ...
  @override
  State<GroupTransferPage> createState() {
    return GroupTransferPageState();
  }
}

class GroupTransferPageState extends State<GroupTransferPage> {
    ...
    if (formKey.currentState != null && formKey.currentState!.validate()) {
      ...
      if (responseTransferReceive != null) {
        transferData = TransferPost(
            tran_amt: tran_amt,
            req_account_id: _selectedAccount.account_id,
            req_account_num: _selectedAccount.account_num,
  ...
  late String account_num; // 수취인 조회
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: TextFormField(
                        initialValue: widget.accountNum,
