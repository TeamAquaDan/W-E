...
<table>
  <tr>
    <td><img src="./docs/gif/친구추가방명록.gif" width="200px" height="400px"></td>
    <td><img src="./docs/gif/저축목표등록.gif" width="200px" height="400px"></td>
    <td><img src="./docs/gif/저축목표완료.gif" width="200px" height="400px"></td>
  </tr>
  <tr>
    <td><img src="./docs/gif/더치페이.gif" width="200px" height="400px"></td>
    <td><img src="./docs/gif/용돈미션.gif" width="200px" height="400px"></td>
  </tr>
</table>
